(defproject metabase/athena-driver "1.0.0-athena-jdbc-2.0.21"
  ...
  :dependencies
  [[athena/athena-jdbc "2.0.21"]
    [org.aws.labs/athena-jdbc-custom-credentials-provider "0.0.1-SNAPSHOT"]]
